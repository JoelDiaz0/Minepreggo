...
@OnlyIn(Dist.CLIENT)
public class FemaleHumanoidModel<E extends LivingEntity> extends HumanoidModel<E> { 

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "female_humanoid_model"), "main");
	
	public final ModelPart boobs;

	public FemaleHumanoidModel(ModelPart root) {
		super(root);
