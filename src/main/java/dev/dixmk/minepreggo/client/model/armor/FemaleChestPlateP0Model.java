...
public class FemaleChestPlateP0Model<T extends LivingEntity> extends EntityModel<T> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "female_chestplate_p0_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		body.addOrReplaceChild("Boobs_r1", CubeListBuilder.create().texOffs(15, 0).addBox(-4.0F, -1.5F, -2.0F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 3.727F, -3.7479F, -1.2217F, 0.0F, 0.0F));
