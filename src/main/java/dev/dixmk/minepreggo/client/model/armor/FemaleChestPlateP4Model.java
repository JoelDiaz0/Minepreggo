...
public class FemaleChestPlateP4Model extends AbstractFemaleChestPlateModel<LivingEntity> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "female_chestplate_p4_model"), "main");

	public FemaleChestPlateP4Model(ModelPart root) {
		super(root);
	}
