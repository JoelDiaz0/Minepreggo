...
@OnlyIn(Dist.CLIENT)
public class AnimatedTamableCreeperGirlP1Model extends AbstractTamablePregnantCreeperGirlModel<TamableCreeperGirlP1> {
	
	public AnimatedTamableCreeperGirlP1Model(ModelPart root) {
		super(root, new HierarchicalModel<TamableCreeperGirlP1>() {
