...
@OnlyIn(Dist.CLIENT)
public class TamableCreeperGirlP1Model extends AbstractTamablePregnantCreeperGirlModel<TamableCreeperGirlP1> {
	
	public TamableCreeperGirlP1Model(ModelPart root) {
