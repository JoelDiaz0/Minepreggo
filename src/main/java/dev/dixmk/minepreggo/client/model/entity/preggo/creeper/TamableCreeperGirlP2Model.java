...
@OnlyIn(Dist.CLIENT)
public class TamableCreeperGirlP2Model extends AbstractTamablePregnantCreeperGirlModel<TamableCreeperGirlP2> {
	public TamableCreeperGirlP2Model(ModelPart root) {
