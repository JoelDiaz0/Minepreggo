...
@OnlyIn(Dist.CLIENT)
public class AbstractEnderGirlModel extends PregnantFemaleHumanoidModel<TamableAnimal>{

	public AbstractEnderGirlModel(ModelPart root) {
		super(root);
	}
	...
	protected static void createBasicBodyLayer(PartDefinition partdefinition, float extraLeftArmRotationZ, float extraRightArmRotationZ) {
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-0.5F)), PartPose.offset(0.0F, -15.5F, 0.0F));
		head.addOrReplaceChild("top_head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 48).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, -16.0F, 0.0F));
		...
		.texOffs(33, 32).addBox(-4.0F, 7.0F, -1.4F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, -14.0F, 0.0F));

		partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -13.0F, 0.0F, 0, 0, extraRightArmRotationZ));

		partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.0F, -13.0F, 0.0F, 0, 0, extraLeftArmRotationZ));

		PartDefinition rightLeg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(56, 13).addBox(-1.0F, 12.0F, -1.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(56, 0).addBox(-1.0F, 1.5F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.25F))
		.texOffs(56, 11).mirror().addBox(-1.0F, -0.5F, 0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offset(-2.0F, -5.0F, 0.0F));

		rightLeg.addOrReplaceChild("extraCube2_r1", CubeListBuilder.create().texOffs(56, 13).mirror().addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offsetAndRotation(0.0F, 24.8993F, 0.248F, -0.0873F, 0.0F, 0.0F));
		...
		.texOffs(56, 13).mirror().addBox(-1.0F, 12.0F, -1.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(56, 11).mirror().addBox(-1.0F, -0.5F, 0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offset(2.0F, -5.0F, 0.0F));
		...
		leftLeg.addOrReplaceChild("extraCube2_r2", CubeListBuilder.create().texOffs(56, 13).mirror().addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offsetAndRotation(0.0F, 24.8993F, 0.248F, -0.0873F, 0.0F, 0.0F));
	...
	public static LayerDefinition createP0BodyLayer() {	
		...
		PartDefinition boobs = partdefinition.getChild("body").addOrReplaceChild("boobs", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.0F, -1.4F, -0.1134F, 0.0F, 0.0F));
