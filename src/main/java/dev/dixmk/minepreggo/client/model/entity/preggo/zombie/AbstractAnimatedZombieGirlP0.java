...
public abstract class AbstractAnimatedZombieGirlP0<E extends AbstractZombieGirl> extends AbstractZombieGirlModel<E> {
	...
	protected AbstractAnimatedZombieGirlP0(ModelPart root, HierarchicalModel<E> animator) {
		super(root);
		this.root = root;
		this.animator = animator;
		this.setVisibleBelly(false);
	}
