...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractAnimatedZombieGirlP0Model<E extends AbstractZombieGirl> extends AbstractZombieGirlModel<E> {
	...
	protected AbstractAnimatedZombieGirlP0Model(ModelPart root, HierarchicalModel<E> animator) {
		super(root);
		this.root = root;
