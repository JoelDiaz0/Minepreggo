...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractAnimatedZombieGirlP1Model<E extends AbstractZombieGirl> extends AbstractZombieGirlModel<E> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "zombie_girl_p1_model"), "main");

	protected final ModelPart root;
	protected HierarchicalModel<E> animator;
	
	protected AbstractAnimatedZombieGirlP1Model(ModelPart root, HierarchicalModel<E> animator) {
		super(root);
		this.root = root;
