...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractAnimatedZombieGirlP4Model<E extends AbstractZombieGirl> extends AbstractZombieGirlModel<E> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "zombie_girl_p4_model"), "main");

	protected final ModelPart root;
	protected HierarchicalModel<E> animator;
	
	protected AbstractAnimatedZombieGirlP4Model(ModelPart root, HierarchicalModel<E> animator) {
		super(root);
		this.root = root;
