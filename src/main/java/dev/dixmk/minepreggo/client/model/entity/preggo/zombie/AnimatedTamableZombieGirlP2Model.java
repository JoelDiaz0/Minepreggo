...
@OnlyIn(Dist.CLIENT)
public class AnimatedTamableZombieGirlP2Model extends AbstractTamablePregnantZombieGirlModel<TamableZombieGirlP2> {

	public AnimatedTamableZombieGirlP2Model(ModelPart root) {
