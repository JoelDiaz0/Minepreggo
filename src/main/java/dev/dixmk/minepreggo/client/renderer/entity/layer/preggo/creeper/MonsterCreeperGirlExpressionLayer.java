...
public class MonsterCreeperGirlExpressionLayer 
	<E extends AbstractMonsterCreeperGirl, M extends AbstractMonsterCreeperGirlModel<E>> extends RenderLayer<E, M> {
	...
	public MonsterCreeperGirlExpressionLayer(RenderLayerParent<E, M> p_117346_) {
		super(p_117346_);
	}
	...
	public void render(PoseStack poseStack, MultiBufferSource p_117350_, int p_117351_, E p_117352_, float p_117353_,
		...
		getParentModel().head.render(poseStack, p_117350_.getBuffer(HOSTIL), p_117351_, OverlayTexture.NO_OVERLAY);	
	}
}
