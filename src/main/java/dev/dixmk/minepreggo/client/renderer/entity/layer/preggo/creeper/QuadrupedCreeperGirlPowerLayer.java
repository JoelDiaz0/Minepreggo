...
@OnlyIn(Dist.CLIENT)
public class QuadrupedCreeperGirlPowerLayer
	<E extends AbstractCreeperGirl, M extends AbstractQueadrupedCreeperGirlModel<E>> extends EnergySwirlLayer<E, M> {
	...
	public QuadrupedCreeperGirlPowerLayer(RenderLayerParent<E, M> p_174471_, EntityModelSet p_174472_, M main) {
		super(p_174471_);
		this.model = main;
	}
