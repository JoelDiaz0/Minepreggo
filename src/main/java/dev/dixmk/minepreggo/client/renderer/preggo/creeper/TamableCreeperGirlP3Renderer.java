...
import dev.dixmk.minepreggo.client.model.entity.preggo.creeper.TamableCreeperGirlP3Model;
...
@OnlyIn(Dist.CLIENT)
public class TamableCreeperGirlP3Renderer extends AbstractTamablePregnantCreeperGirlRenderer<TamableCreeperGirlP3, TamableCreeperGirlP3Model> {
	...
	public TamableCreeperGirlP3Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
		super(context, new TamableCreeperGirlP3Model(context.bakeLayer(main)), new TamableCreeperGirlP3Model(context.bakeLayer(inner)), new TamableCreeperGirlP3Model(context.bakeLayer(outter)), new TamableCreeperGirlP3Model(context.bakeLayer(armor)));
	}

	@Override
	public ResourceLocation getTextureLocation(TamableCreeperGirlP3 p_115812_) {
		return AbstractHumanoidCreeperGirlRenderer.CREEPER_GIRL_P3_LOCATION;
	}
