...
@OnlyIn(Dist.CLIENT)
public class TamableCreeperGirlP4Renderer extends AbstractTamablePregnantCreeperGirlRenderer<TamableCreeperGirlP4, TamableCreeperGirlP4Model> {
	...
	public TamableCreeperGirlP4Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
		super(context, new TamableCreeperGirlP4Model(context.bakeLayer(main)), new TamableCreeperGirlP4Model(context.bakeLayer(inner)), new TamableCreeperGirlP4Model(context.bakeLayer(outter)), new TamableCreeperGirlP4Model(context.bakeLayer(armor)));
	}
