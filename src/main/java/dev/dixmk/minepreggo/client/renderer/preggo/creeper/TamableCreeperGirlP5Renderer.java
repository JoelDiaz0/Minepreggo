...
import dev.dixmk.minepreggo.client.model.entity.preggo.creeper.TamableCreeperGirlP5Model;
...
@OnlyIn(Dist.CLIENT)
public class TamableCreeperGirlP5Renderer extends AbstractTamablePregnantCreeperGirlRenderer<TamableCreeperGirlP5, TamableCreeperGirlP5Model> {
	...
	public TamableCreeperGirlP5Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
		super(context, new TamableCreeperGirlP5Model(context.bakeLayer(main)), new TamableCreeperGirlP5Model(context.bakeLayer(inner)), new TamableCreeperGirlP5Model(context.bakeLayer(outter)), new TamableCreeperGirlP5Model(context.bakeLayer(armor)));
	}
