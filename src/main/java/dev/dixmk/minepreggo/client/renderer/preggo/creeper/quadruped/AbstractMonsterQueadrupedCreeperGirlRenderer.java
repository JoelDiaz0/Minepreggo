...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractMonsterQueadrupedCreeperGirlRenderer 
	...
	protected AbstractMonsterQueadrupedCreeperGirlRenderer(Context context, M main, M armor) {
