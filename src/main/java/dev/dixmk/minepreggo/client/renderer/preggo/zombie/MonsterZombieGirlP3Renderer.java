...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.AnimatedMonsterZombieGirlP3Model;
...
@OnlyIn(Dist.CLIENT)
public class MonsterZombieGirlP3Renderer extends AbstractMonsterPregnantZombieGirlRenderer<MonsterZombieGirlP3, AnimatedMonsterZombieGirlP3Model> {
	...
	public MonsterZombieGirlP3Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new AnimatedMonsterZombieGirlP3Model(context.bakeLayer(main)), new AnimatedMonsterZombieGirlP3Model(context.bakeLayer(inner)), new AnimatedMonsterZombieGirlP3Model(context.bakeLayer(outter)));
	}
