...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.AnimatedMonsterZombieGirlP5Model;
...
@OnlyIn(Dist.CLIENT)
public class MonsterZombieGirlP5Renderer extends AbstractMonsterPregnantZombieGirlRenderer<MonsterZombieGirlP5, AnimatedMonsterZombieGirlP5Model> {
	...
	public MonsterZombieGirlP5Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new AnimatedMonsterZombieGirlP5Model(context.bakeLayer(main)), new AnimatedMonsterZombieGirlP5Model(context.bakeLayer(inner)), new AnimatedMonsterZombieGirlP5Model(context.bakeLayer(outter)));
	}
