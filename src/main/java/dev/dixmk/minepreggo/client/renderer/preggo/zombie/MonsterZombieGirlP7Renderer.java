...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.MonsterZombieGirlP7Model;
...
@OnlyIn(Dist.CLIENT)
public class MonsterZombieGirlP7Renderer extends AbstractMonsterPregnantZombieGirlRenderer<MonsterZombieGirlP7, MonsterZombieGirlP7Model> {
	...
	public MonsterZombieGirlP7Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new MonsterZombieGirlP7Model(context.bakeLayer(main)), new MonsterZombieGirlP7Model(context.bakeLayer(inner)), new MonsterZombieGirlP7Model(context.bakeLayer(outter)));
	}
