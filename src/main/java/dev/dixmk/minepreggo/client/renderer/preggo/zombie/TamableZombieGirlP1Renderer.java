...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.AnimatedTamableZombieGirlP1Model;
...
@OnlyIn(Dist.CLIENT) 
public class TamableZombieGirlP1Renderer extends AbstractTamablePregnantZombieGirlRenderer<TamableZombieGirlP1, AnimatedTamableZombieGirlP1Model> {
	...
	public TamableZombieGirlP1Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new AnimatedTamableZombieGirlP1Model(context.bakeLayer(main)), new AnimatedTamableZombieGirlP1Model(context.bakeLayer(inner)), new AnimatedTamableZombieGirlP1Model(context.bakeLayer(outter)));
	}
