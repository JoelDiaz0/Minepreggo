...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.AnimatedTamableZombieGirlP3Model;
...
@OnlyIn(Dist.CLIENT) 
public class TamableZombieGirlP3Renderer extends AbstractTamablePregnantZombieGirlRenderer<TamableZombieGirlP3, AnimatedTamableZombieGirlP3Model> {
	...
	public TamableZombieGirlP3Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new AnimatedTamableZombieGirlP3Model(context.bakeLayer(main)), new AnimatedTamableZombieGirlP3Model(context.bakeLayer(inner)), new AnimatedTamableZombieGirlP3Model(context.bakeLayer(outter)));
	}
