...
import dev.dixmk.minepreggo.client.model.entity.preggo.zombie.AnimatedTamableZombieGirlP6Model;
...
@OnlyIn(Dist.CLIENT) 
public class TamableZombieGirlP6Renderer extends AbstractTamablePregnantZombieGirlRenderer<TamableZombieGirlP6, AnimatedTamableZombieGirlP6Model> {
	...
	public TamableZombieGirlP6Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter) {
		super(context, new AnimatedTamableZombieGirlP6Model(context.bakeLayer(main)), new AnimatedTamableZombieGirlP6Model(context.bakeLayer(inner)), new AnimatedTamableZombieGirlP6Model(context.bakeLayer(outter)));
	}
