...
public abstract class AbstractMonsterZombieGirl extends AbstractZombieGirl {
	...
	public boolean canHoldItem(ItemStack p_34332_) {
		return this.isPassenger() ? false : super.canHoldItem(p_34332_);
	}
	...
	*/
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new HurtByTargetGoal(this).setAlertOthers(AbstractMonsterZombieGirl.class, Zombie.class));	
		...
		this.goalSelector.addGoal(7, new AbstractMonsterZombieGirl.ZombieAttackTurtleEggGoal(this, 1.0, 3));
	...
	protected static AttributeSupplier.Builder getBasicAttributes() {
		AttributeSupplier.Builder builder = Mob.createMobAttributes();
		builder = builder.add(Attributes.MAX_HEALTH, 20);
		builder = builder.add(Attributes.ARMOR, 0);
		builder = builder.add(Attributes.ATTACK_DAMAGE, 3D);
		builder = builder.add(Attributes.FOLLOW_RANGE, 35d);
