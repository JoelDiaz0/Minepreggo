...
import dev.dixmk.minepreggo.item.BellyShieldP4Item;
import dev.dixmk.minepreggo.item.BellyShieldP5Item;
import dev.dixmk.minepreggo.item.BellyShieldP6Item;
import dev.dixmk.minepreggo.item.BellyShieldP7Item;
...
import dev.dixmk.minepreggo.item.DiamondKneeBraceItem;
import dev.dixmk.minepreggo.item.ExplosiveBreastMilkBottleItem;
import dev.dixmk.minepreggo.item.FemaleChainmailChestPlateItem;
import dev.dixmk.minepreggo.item.FemaleChainmailChestPlateP1Item;
import dev.dixmk.minepreggo.item.FemaleChainmailChestPlateP2Item;
import dev.dixmk.minepreggo.item.FemaleChainmailChestPlateP3Item;
import dev.dixmk.minepreggo.item.FemaleDiamondChestPlateItem;
import dev.dixmk.minepreggo.item.FemaleDiamondChestPlateP1Item;
import dev.dixmk.minepreggo.item.FemaleDiamondChestPlateP2Item;
import dev.dixmk.minepreggo.item.FemaleDiamondChestPlateP3Item;
import dev.dixmk.minepreggo.item.FemaleGoldenChestPlateItem;
import dev.dixmk.minepreggo.item.FemaleGoldenChestPlateP1Item;
import dev.dixmk.minepreggo.item.FemaleGoldenChestPlateP2Item;
import dev.dixmk.minepreggo.item.FemaleGoldenChestPlateP3Item;
import dev.dixmk.minepreggo.item.FemaleIronChestPlateItem;
import dev.dixmk.minepreggo.item.FemaleIronChestplateP1Item;
import dev.dixmk.minepreggo.item.FemaleIronChestplateP2Item;
import dev.dixmk.minepreggo.item.FemaleIronChestplateP3Item;
import dev.dixmk.minepreggo.item.FemaleNetheriteChestPlateItem;
import dev.dixmk.minepreggo.item.FemaleNetheriteChestPlateP1Item;
import dev.dixmk.minepreggo.item.FemaleNetheriteChestPlateP2Item;
import dev.dixmk.minepreggo.item.FemaleNetheriteChestPlateP3Item;
import dev.dixmk.minepreggo.item.GoldKneeBraceItem;
import dev.dixmk.minepreggo.item.HotChickenItem;
import dev.dixmk.minepreggo.item.HotSauceItem;
import dev.dixmk.minepreggo.item.IronKneeBraceItem;
...
import dev.dixmk.minepreggo.item.NetheriteKneeBraceItem;
...
public class MinepreggoModItems {
	...
	public static final RegistryObject<Item> ZOMBIE_GIRL_SPAWN_EGG = REGISTRY.register("zombie_girl_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.ZOMBIE_GIRL, -16724839, -16738048, new Item.Properties()));
