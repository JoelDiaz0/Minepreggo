...
public abstract class FemaleChainmailChestPlateP3Item extends ArmorItem {
	public FemaleChainmailChestPlateP3Item(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends FemaleChainmailChestPlateP3Item {
		public Chestplate() {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new ModelFemaleChestPlateP3(Minecraft.getInstance().getEntityModels().bakeLayer(ModelFemaleChestPlateP3.LAYER_LOCATION)).Body,
							"left_arm", new ModelFemaleChestPlateP3(Minecraft.getInstance().getEntityModels().bakeLayer(ModelFemaleChestPlateP3.LAYER_LOCATION)).Body, "right_arm",
							new ModelFemaleChestPlateP3(Minecraft.getInstance().getEntityModels().bakeLayer(ModelFemaleChestPlateP3.LAYER_LOCATION)).Body, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
