...
public abstract class FemaleDiamondChestPlateP2Item extends ArmorItem {
	protected FemaleDiamondChestPlateP2Item(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends FemaleDiamondChestPlateP2Item {
		public Chestplate() {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel<?> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> defaultModel) {
					var armorModel = new HumanoidModel<LivingEntity>(new ModelPart(Collections.emptyList(), Map.of("body", new FemaleChestPlateP2Model<>(Minecraft.getInstance().getEntityModels().bakeLayer(FemaleChestPlateP2Model.LAYER_LOCATION)).body,
