...
public abstract class FemaleDiamondChestPlateP3Item extends ArmorItem {
	protected FemaleDiamondChestPlateP3Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.DIAMOND), new ItemStack(Items.DIAMOND_CHESTPLATE), new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P_1_CHESTPLATE.get()), new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P_2_CHESTPLATE.get()));
			}

			@Override
			public String getName() {
				return "female_diamond_chest_plate_p_3";
			}
	...
	public static class Chestplate extends FemaleDiamondChestPlateP3Item {
		public Chestplate() {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel<?> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> defaultModel) {
					var armorModel = new HumanoidModel<LivingEntity>(new ModelPart(Collections.emptyList(), Map.of("body", new FemaleChestPlateP3Model<>(Minecraft.getInstance().getEntityModels().bakeLayer(FemaleChestPlateP3Model.LAYER_LOCATION)).body,
