...
public abstract class BellyShieldP8Item extends ArmorItem {
	protected BellyShieldP8Item(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends BellyShieldP8Item {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minepreggo:textures/models/armor/shield_base_p8_layer_1.png";
		}
	}
}
