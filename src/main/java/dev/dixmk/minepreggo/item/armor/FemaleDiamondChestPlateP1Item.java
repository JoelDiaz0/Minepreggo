...
public abstract class FemaleDiamondChestPlateP1Item extends ArmorItem {
	protected FemaleDiamondChestPlateP1Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "female_diamond_chest_plate_p_1";
			}
	...
	public static class Chestplate extends FemaleDiamondChestPlateP1Item {
		public Chestplate() {
