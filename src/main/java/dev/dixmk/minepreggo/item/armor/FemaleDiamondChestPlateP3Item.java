		...
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.DIAMOND), new ItemStack(Items.DIAMOND_CHESTPLATE), new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P0_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P1_CHESTPLATE.get()), new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P2_CHESTPLATE.get()));
			}

			@Override
			public String getName() {
				return "female_diamond_chest_plate_p3";
			}
