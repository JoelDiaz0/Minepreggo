...
public abstract class FemaleDiamondChestPlateP4Item extends ArmorItem {
	protected FemaleDiamondChestPlateP4Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.DIAMOND),
						...
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P0_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P1_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P2_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_DIAMOND_CHEST_PLATE_P3_CHESTPLATE.get()));
			}

			@Override
			public String getName() {
				return "female_diamond_chest_plate_p4";
			}
	...
	public static class Chestplate extends FemaleDiamondChestPlateP4Item {
		public Chestplate() {
