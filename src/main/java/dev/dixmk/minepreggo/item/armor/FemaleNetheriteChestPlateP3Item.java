...
public abstract class FemaleNetheriteChestPlateP3Item extends ArmorItem {
	protected FemaleNetheriteChestPlateP3Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.NETHERITE_INGOT), new ItemStack(Items.NETHERITE_CHESTPLATE), new ItemStack(MinepreggoModItems.FEMALE_NETHERITE_CHEST_PLATE_P0_CHESTPLATE.get()),
						new ItemStack(MinepreggoModItems.FEMALE_NETHERITE_CHEST_PLATE_P1_CHESTPLATE.get()), new ItemStack(MinepreggoModItems.FEMALE_NETHERITE_CHEST_PLATE_P2_CHESTPLATE.get()));
			}
