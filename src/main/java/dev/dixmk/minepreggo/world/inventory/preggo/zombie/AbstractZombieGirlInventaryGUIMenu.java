...
public abstract class AbstractZombieGirlInventaryGUIMenu<T extends AbstractTamableZombieGirl> extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	protected AbstractZombieGirlInventaryGUIMenu(MenuType<?> menuType, Class<T> zombieGirlClass, int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 134, 43)));
		this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 152, 43)));
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 134, 61)));
		this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 152, 61)));
